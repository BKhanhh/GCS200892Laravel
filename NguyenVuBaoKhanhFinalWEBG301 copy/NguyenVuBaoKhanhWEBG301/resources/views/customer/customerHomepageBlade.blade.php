            ...
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <form class="form-inline ">
                  <div class="login_text">
                     <ul>
                        <li><a href="{{ url('admin/adminLoginPageBlade') }}"><img src="images/user-icon.png"></a></li>
      ...
      <div class="catagary_section_2">
         <div class="container-fluid">
            <div class="row">
               ...
               @foreach ($customerShowProductDatabase as $productShowDatabase )
               <div class="col-md-4">
                <div class="box_man">
                   <h3 class="mobile_text">{{$productShowDatabase->productName}}</h3>
                   <div class="camera_img"><img src="../product-image/{{ $productShowDatabase->productImage }}"></div>
                   <div class="cart_main">
                      <div class="cart_bt"><a href="#">Add To Cart</a></div>
                      <h4 class="samsung_text">{{ $productShowDatabase->categoryName }}</h4>
                      <h6 class="rate_text"><a href="#">${{ $productShowDatabase->productPrice }}</a></h6>
                      <h6 class="rate_text_1">$100000</h6>
                   </div>
                   <div h6 class="rate_text_2"> Product Detail: {{ $productShowDatabase->productDetail }} </div>
                </div>
               </div>
               @endforeach
